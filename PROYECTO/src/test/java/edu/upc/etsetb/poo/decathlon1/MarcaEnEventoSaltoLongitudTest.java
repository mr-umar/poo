...
import edu.upc.etsetb.poo.decathlon1.dominio.MarcaEnEventoSaltoLongitud;
...
public class MarcaEnEventoSaltoLongitudTest extends AccreditedSuperClassForTests {
    ...
    public MarcaEnEventoSaltoLongitudTest() {
        super();
        numInstances++;
        if (numInstances == 1) {
    ...
    public static void tearDownClass() {
        showErrors(indErrors, "MarcaEnEventoSaltoLongitud");
        nota.put("MarcaEnEventoSaltoLongitud", puntosTotales);
        puntosTotales = 0;
    }
    ...
    public void test01_Constructor(){
        ...
        this.printlnAlways("\nMarcaEnEventoSaltoLongitud::"
                + "MarcaEnEventoSaltoLongitud(...). Valor: " + valorTotal);
        //
        ...
        try {
            instance = new MarcaEnEventoSaltoLongitud(marca);
    ...
    public void test02_toString() {
        ...
        try {
            ...
            int pos1 = result.indexOf("saltodelongitud");
            int pos2 = result.indexOf("saltolongitud");
