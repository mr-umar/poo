...
import edu.upc.etsetb.poo.decathlon1.dominio.MarcaEnEvento400m;
...
public class MarcaEnEvento400mTest extends AccreditedSuperClassForTests {
    ...
    public static void tearDownClass() {
        showErrors(indErrors, "MarcaEnEvento400m");
        nota.put("MarcaEnEvento400m", puntosTotales);
        puntosTotales = 0;
    }
    ...
    public void test01_Constructor() {
        ...
        //QUÉ VALOR TIENE
        this.printlnAlways("\nMarcaEnEvento400m::"
                + "MarcaEnEvento400m(...). Valor: " + valorTotal);
        //
        ...
        try {
            instance = new MarcaEnEvento400m(marca);
            this.checkAttributeAfterConstructor(instance, "marca", marca,
                    valorTotal, 1.0 / nTests, 1.0 / nTests, 1);
            this.checkAttributeAfterConstructor(instance, "puntos", 800,
