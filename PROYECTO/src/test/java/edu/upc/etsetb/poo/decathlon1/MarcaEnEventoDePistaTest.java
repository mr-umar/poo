...
import edu.upc.etsetb.poo.decathlon1.dominio.MarcaEnEventoDePista;
...
public class MarcaEnEventoDePistaTest extends AccreditedSuperClassForTests {
    ...
    public MarcaEnEventoDePistaTest() {
        super();
        numInstances++;
        if (numInstances == 1) {
    ...
    public static void tearDownClass() {
        showErrors(indErrors, "MarcaEnEventoDePista");
        nota.put("MarcaEnEventoDePista", puntosTotales);
        puntosTotales = 0;
    }
    ...
    private MarcaEnEventoDePista createAbstractInstance(double marca){
        MarcaEnEventoDePista me = new MarcaEnEventoDePista(marca){
        };
        return me;
    }
