...
public class MarcaEnEventoSaltoAltura extends MarcaEnEventoDeCampo {
     ...
     */
    public static final double A = 0.8465;
    public static final double B = 75.0;
    public static final double C = 1.42;
     ...
     */
    public MarcaEnEventoSaltoAltura(double marca) throws MarcaNegativaException {
        super(marca);
        this.evento = MarcaEnEvento.SALTO_DE_ALTURA;
