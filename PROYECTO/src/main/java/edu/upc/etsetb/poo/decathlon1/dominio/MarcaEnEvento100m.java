...
public class MarcaEnEvento100m extends MarcaEnEventoDePista {
     ...
     */
    public static final double A = 25.4347;
    public static final double B = 18.0;
     ...
     */
    public MarcaEnEvento100m(double marca) throws MarcaNegativaException {
        super(marca);
        this.evento = MarcaEnEvento.CIEN_METROS;
